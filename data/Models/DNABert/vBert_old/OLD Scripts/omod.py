...
KMER = 6  # The length of the K-mers to be used by the model and tokenizer

#training_data_path = Path("../TrVaTe/aspect/ASPECT/data/TrVaTe/train_data.csv")

training_data_path = Path("../TrVaTe/train_data.csv")
eval_data_path = Path("../TrVaTe/val_data.csv") 
...
for val_dataset in val_dataset_generator(
	tokenizer, kmer_size=KMER, val_dir="../TrVaTe/test/"
):
