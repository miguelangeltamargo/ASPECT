...
data = np.genfromtxt("/aspect/ASPECT/data/datasets/3'100.csv", delimiter=',', dtype=object, skip_header=1, usecols=range(15), encoding='cp1252')
...
with open(output_file, 'w') as f:
    ...
    for row in filtered_data:
        ...
        strand = row[3]
        protNm = row[14]
        classname = "3' Alternative Splice Event"
        i+=1
        ...
        writer.writerow([protNm+' | '+ row[0], '4', classname, seq_data])
